...
import { ChevronLeft, AlertCircle, Ticket as TicketIcon } from 'lucide-react';
            ...
            <Layout title="Use ticket">
                <Section className="pt-10 pb-20">
                    <Container className="max-w-xl">
                        ...
                        <Reveal delay={0.05}>
                            <h1 className="font-serif text-display-md text-fg mt-5 tracking-tight">Use a ticket</h1>
                        </Reveal>
                        <Reveal delay={0.1}>
                            <p className="mt-3 text-[15px] text-muted">Mark a ticket as redeemed for entry.</p>
                        </Reveal>
                        <Reveal delay={0.15}>
                            <Card className="mt-8 p-6">
                                <form onSubmit={this.onSubmit} className="flex flex-col gap-5">
                                    ...
                                    <Button
                                        ...
                                        leftIcon={<TicketIcon size={15} strokeWidth={1.75} />}
